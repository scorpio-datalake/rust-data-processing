...
| [006](006-jvm-orchestration-pipeline-json.md) | **`rdp_run_pipeline_json`**: versioning, orchestration limits, structured errors; lake/JDBC sink contract (**P3-E1-S9/S10**) |
